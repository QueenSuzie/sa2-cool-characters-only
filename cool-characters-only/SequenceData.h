...
enum Event {
    ...
    EGGMAN_THREATENS_AMY = 113,
    ROUGE_REPORTS_PROBLEM = 116,
    EGG_GOLEM_ENTRANCE_DARK = 123,
    DARK_TEAM_VICTORY = 131,
    SHADOW_RESCUES_ROUGE_PT1 = 133,
    SHADOW_RESCUES_ROUGE_PT2 = 134,
    SHADOW_RESCUES_ROUGE_FULL = 118,
    ROUGE_HEADS_FOR_SPACE_EMERALDS = 124,
    KNUCKLES_RESCUES_ROUGE_DARK = 126,
    EGGMAN_OUTPLAYS_HEROES_DARK = 128,
    SHADOW_CONFRONTS_ROUGE = 129,
    SHADOW_VS_SONIC_2_DARK = 130,
    ECLIPSE_CANON_DESTRUCTION_SEQUENCE = 200,
    PRISON_ISLAND_BLOWS_UP = 409,
    SHUTTLE_LAUNCH_HERO = 420,
    DARK_STORY_TRAILER = 429,
    SHUTTLE_LAUNCH_DARK = 524,
